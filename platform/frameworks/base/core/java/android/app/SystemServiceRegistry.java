...
import android.os.IRestoreconService;
...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.RESTORECON_SERVICE, RestoreconManager.class,
                new CachedServiceFetcher<RestoreconManager>() {
            @Override
            public RestoreconManager createService(ContextImpl ctx) {
                IBinder b = ServiceManager.getService(Context.RESTORECON_SERVICE);
                IRestoreconService service = IRestoreconService.Stub.asInterface(b);
                return new RestoreconManager(ctx, service);
            }});
