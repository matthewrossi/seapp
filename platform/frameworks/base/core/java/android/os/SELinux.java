...
public class SELinux {
    ...
    /**
     * Changes the security context of the current process.
     * @param context new security context given as a String.
     * @return a security context given as a String.
     */
    public static native boolean setContext(String context);
     ...
     * @exception NullPointerException if the file is a null object.
     */
    public static boolean restoreFileContext(String pathname) throws NullPointerException {   // TODO: check pathname doesn't exit app scope
        if (pathname == null) { throw new NullPointerException(); }
        return native_restorecon(pathname, SELINUX_ANDROID_RESTORECON_DATADATA);
    }
     ...
     * @exception NullPointerException if the file is a null object.
     */
    public static boolean restoreFileContextRecursive(String pathname) throws NullPointerException {   // TODO: check pathname doesn't exit app scope
        if (pathname == null) { throw new NullPointerException(); }
        return native_restorecon(pathname,
                SELINUX_ANDROID_RESTORECON_RECURSE | SELINUX_ANDROID_RESTORECON_DATADATA);
    }
}
