...
# Add seapp_macros sepolicy file
LOCAL_REQUIRED_MODULES += \
    seapp_macros_sepolicy_cil_file.cil
...
include $(CLEAR_VARS)
LOCAL_MODULE := seapp_macros_sepolicy_cil_file.cil
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/selinux
LOCAL_SRC_FILES := $(LOCAL_MODULE)

# seapp_macros - A cil sepolicy file containing the macros that can be used by security enhanced apps
