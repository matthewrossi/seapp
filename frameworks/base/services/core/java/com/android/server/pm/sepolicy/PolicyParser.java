...
public class PolicyParser {
    ...
    private static final String UNTRUSTED_APP_TMPFS = "untrusted_app_tmpfs";
    ...
    public static class ParseTree {
        ...
        public boolean isCompliant(String pkgName) {
            ...
            ArrayList<String> queue = new ArrayList<>(Arrays.asList(UNTRUSTED_APP, APP_DATA_FILE, UNTRUSTED_APP_TMPFS));
            ...
            for (String dest : typetransition) {
                // all typetransition must be local and bounded
