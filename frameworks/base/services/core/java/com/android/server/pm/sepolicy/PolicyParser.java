...
public class PolicyParser {
    ...
    private static final ArrayList<String> CIL_KEY_AVRULES = new ArrayList<String>() {{
        add("allow");
        add("auditallow");
        add("dontaudit");
        add("neverallow");
    ...
    public static class ParseTree {
        ...
        public boolean isCompliant(String pkgName) {
            ...
            // typeattributeset can't be resolved once and for all, as it may hide externally
        ...
        private boolean processNode(Node node) {
            ...
            } else if (CIL_KEY_TYPEATTRIBUTE.contains(key.data)) {
            ...
            } else if (CIL_KEY_TYPEATTRIBUTESET.contains(key.data)) {
